...
class ImportReservedUnitsCommand extends Command
{
    protected $signature = 'import:reserved-units
    ...
    protected $description = 'Import reserved units + vehicle expenses from Reserved Excel JSON export';

    public function handle(): int
    {
        $path = $this->option('file');
        if (! $path) {
            $this->error('Provide --file= path to JSON export.');
            ...
            try {
                ...
                DB::transaction(function () use (
                    ...
                    $payload = [
                        ...
                        'purchase_date' => $row['purchase_date'] ?? now()->toDateString(),
