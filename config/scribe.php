...
return [
    ...
    'description' => 'JSON API for Car Empire Management System — autocomplete, chat, expenses, SOA, tools, and vehicle operations.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            These endpoints power dynamic features in CEMS (autocomplete fields, live chat, SOA, etc.).

            **Authentication:** Log in to the web app first. Endpoints use Laravel **session cookies**, not API tokens.

            <aside>When using <strong>Try It Out</strong>, keep this docs tab in the same browser where you are logged in to CEMS.</aside>
        INTRO,
    ...
    'auth' => [
        // Session-based auth: users must be logged in via the web app. Try It Out uses browser cookies.
        'enabled' => false,
        ...
        'extra_info' => 'CEMS uses Laravel session cookies. Log in to the app in this browser before using Try It Out on protected endpoints.',
    ],
