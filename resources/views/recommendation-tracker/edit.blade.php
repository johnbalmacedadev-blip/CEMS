...
@section('title', 'Edit Recommendation - Car Empire Management System')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">
            <i class="fas fa-clipboard-list me-2"></i>Edit Recommendation
        </h1>
        <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <a href="{{ route('recommendation-tracker.show', $recommendation_tracker) }}" class="btn btn-outline-secondary">View</a>
        </div>
    </div>

    <form action="{{ route('recommendation-tracker.update', $recommendation_tracker) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        @include('recommendation-tracker._form')
        <div class="mb-4">
            <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Update Recommendation</button>
