...
@section('title', 'Edit Sales Agent Commission - Car Empire Management System')

@section('content')
@php
    $vehicleDisplay = $sales_agent_commission->vehicle_id && $sales_agent_commission->vehicle
        ? ($sales_agent_commission->vehicle->plate_number ? $sales_agent_commission->vehicle->plate_number . ' — ' : '') . $sales_agent_commission->vehicle->full_name
        : '';
@endphp
<div class="container-fluid">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">
            <i class="fas fa-hand-holding-usd me-2"></i>Edit Commission Record
        </h1>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('sales-agent-commissions.update', $sales_agent_commission) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    @php
                        $showroomSelected = old('showroom', $sales_agent_commission->showroom ?? 'FLAGSHIP');
                    @endphp
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control @error('agent_name') is-invalid @enderror" id="agent_name" name="agent_name" value="{{ old('agent_name', $sales_agent_commission->agent_name) }}" required placeholder="Type to search sales agents…" autocomplete="off">
                        ...
                        <input type="hidden" name="sales_agent_id" id="sales_agent_id" value="{{ old('sales_agent_id', $sales_agent_commission->sales_agent_id) }}">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" id="client_name" name="client_name" value="{{ old('client_name', $sales_agent_commission->client_name) }}">
                    </div>
                    <div class="col-12">
                        <label for="vehicle_search" class="form-label">Search & tag vehicle</label>
                        <div class="input-group">
                            <input type="text" class="form-control @error('vehicle_id') is-invalid @enderror" id="vehicle_search" placeholder="Type plate number, make, model or year to search..." autocomplete="off" value="{{ old('vehicle_display', $vehicleDisplay) }}">
                        ...
                        <input type="hidden" name="vehicle_id" id="vehicle_id" value="{{ old('vehicle_id', $sales_agent_commission->vehicle_id) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="unit" name="unit" value="{{ old('unit', $sales_agent_commission->unit) }}" placeholder="e.g. 2013 FORD EXPLORER — or select vehicle above">
                    </div>
                    <div class="col-md-6">
                        <label for="plate_number" class="form-label">PLATE #</label>
                        <input type="text" class="form-control" id="plate_number" name="plate_number" value="{{ old('plate_number', $sales_agent_commission->plate_number ?? ($sales_agent_commission->vehicle ? $sales_agent_commission->vehicle->plate_number : '')) }}" placeholder="Auto-filled when vehicle tagged">
                    </div>
                    <div class="col-md-4">
                        <label for="transaction_type" class="form-label">TRANSACTION TYPE <span class="text-danger">*</span></label>
                        <select class="form-select" id="transaction_type" name="transaction_type" required>
                            <option value="CASH" {{ old('transaction_type', $sales_agent_commission->transaction_type) === 'CASH' ? 'selected' : '' }}>CASH</option>
                            <option value="FINANCING" {{ old('transaction_type', $sales_agent_commission->transaction_type) === 'FINANCING' ? 'selected' : '' }}>FINANCING</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label for="release_date" class="form-label">RELEASE DATE</label>
                        <input type="date" class="form-control" id="release_date" name="release_date" value="{{ old('release_date', $sales_agent_commission->release_date?->format('Y-m-d')) }}">
                    </div>
                    <div class="col-md-4">
                        <label for="amount" class="form-label">AMOUNT <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text">₱</span>
                            <input type="number" class="form-control @error('amount') is-invalid @enderror" id="amount" name="amount" step="0.01" min="0" value="{{ old('amount', $sales_agent_commission->amount) }}" required>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">₱</span>
                            <input type="number" class="form-control @error('agents_folder_amount') is-invalid @enderror" id="agents_folder_amount" name="agents_folder_amount" step="0.01" min="0" value="{{ old('agents_folder_amount', $sales_agent_commission->agents_folder_amount) }}" placeholder="Optional">
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">₱</span>
                            <input type="number" class="form-control @error('sales_executive_commission') is-invalid @enderror" id="sales_executive_commission" name="sales_executive_commission" step="0.01" min="0" value="{{ old('sales_executive_commission', $sales_agent_commission->sales_executive_commission) }}" placeholder="Optional">
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" name="proof_of_appointment" value="1" id="proof_of_appointment" {{ old('proof_of_appointment', $sales_agent_commission->proof_of_appointment) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" name="sign_client_with_agent" value="1" id="sign_client_with_agent" {{ old('sign_client_with_agent', $sales_agent_commission->sign_client_with_agent) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" class="form-control" id="date_sent" name="date_sent" value="{{ old('date_sent', $sales_agent_commission->date_sent?->format('Y-m-d')) }}">
                    </div>
                    <div class="col-md-3">
                        <label for="date_of_payment" class="form-label">Date of payment</label>
                        <input type="date" class="form-control" id="date_of_payment" name="date_of_payment" value="{{ old('date_of_payment', $sales_agent_commission->date_of_payment?->format('Y-m-d')) }}">
                    </div>
                    <div class="col-12">
                        <label for="notes" class="form-label">Notes</label>
                        <textarea class="form-control" id="notes" name="notes" rows="2">{{ old('notes', $sales_agent_commission->notes) }}</textarea>
                    </div>
                    <div class="col-12">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    @if(old('sales_agent_id', $sales_agent_commission->sales_agent_id))
    selectedAgentId = @json((string) old('sales_agent_id', $sales_agent_commission->sales_agent_id));
    selectedAgentName = @json(old('agent_name', $sales_agent_commission->salesAgent?->name ?? $sales_agent_commission->agent_name));
    @endif
});
</script>
@endsection
