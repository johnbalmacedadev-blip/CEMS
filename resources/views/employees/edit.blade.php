...
@section('title', 'Edit Employee - Car Empire Management System')
        ...
        <main class="col-12 ms-sm-auto px-md-4" id="mainContent">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <div class="d-flex align-items-center">
                    <div class="avatar-lg bg-warning text-dark rounded-circle d-flex align-items-center justify-content-center me-3">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="{{ route('employees.show', $employee) }}" class="btn btn-outline-primary me-2">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">
                                <i class="fas fa-edit me-2"></i>Employee Information
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('contract_start') is-invalid @enderror" 
                                               id="contract_start" name="contract_start" value="{{ old('contract_start', $employee->contract_start ? $employee->contract_start->format('Y-m-d') : '') }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('contract_type') is-invalid @enderror" id="contract_type" name="contract_type">
                                            ...
                                            <option value="PROBATIONARY" {{ old('contract_type', $employee->contract_type) == 'PROBATIONARY' ? 'selected' : '' }}>Probationary</option>
                                            <option value="REGULAR" {{ old('contract_type', $employee->contract_type) == 'REGULAR' ? 'selected' : '' }}>Regular</option>
                                        </select>
                                        @error('contract_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('role') is-invalid @enderror" id="role" name="role">
                                            ...
                                            <option value="ADMIN SALES" {{ old('role', $employee->role) == 'ADMIN SALES' ? 'selected' : '' }}>Admin Sales</option>
                                            <option value="BUFFER - GEN. STAFF" {{ old('role', $employee->role) == 'BUFFER - GEN. STAFF' ? 'selected' : '' }}>Buffer - Gen. Staff</option>
                                            <option value="DATA ENCODER" {{ old('role', $employee->role) == 'DATA ENCODER' ? 'selected' : '' }}>Data Encoder</option>
                                            <option value="DRIVER" {{ old('role', $employee->role) == 'DRIVER' ? 'selected' : '' }}>Driver</option>
                                            <option value="MECHANIC" {{ old('role', $employee->role) == 'MECHANIC' ? 'selected' : '' }}>Mechanic</option>
                                            <option value="SALES ASST. - GEN. STAFF" {{ old('role', $employee->role) == 'SALES ASST. - GEN. STAFF' ? 'selected' : '' }}>Sales Asst. - Gen. Staff</option>
                                        </select>
                                        @error('role')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('location') is-invalid @enderror" id="location" name="location">
                                            ...
                                            <option value="MAIN" {{ old('location', $employee->location) == 'MAIN' ? 'selected' : '' }}>Main</option>
                                            <option value="EXTENSION" {{ old('location', $employee->location) == 'EXTENSION' ? 'selected' : '' }}>Extension</option>
                                            <option value="ANNEX" {{ old('location', $employee->location) == 'ANNEX' ? 'selected' : '' }}>Annex</option>
                                            <option value="PREMIUM" {{ old('location', $employee->location) == 'PREMIUM' ? 'selected' : '' }}>Premium</option>
                                            <option value="WAREHOUSE" {{ old('location', $employee->location) == 'WAREHOUSE' ? 'selected' : '' }}>Warehouse</option>
                                        </select>
                                        @error('location')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('sss') is-invalid @enderror" 
                                               id="sss" name="sss" value="{{ old('sss', $employee->sss) }}" placeholder="XX-XXXXXXX-X">
                                        @error('sss')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('philhealth') is-invalid @enderror" 
                                               id="philhealth" name="philhealth" value="{{ old('philhealth', $employee->philhealth) }}" placeholder="XX-XXXXXXXXX-X">
                                        @error('philhealth')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('pagibig') is-invalid @enderror" 
                                               id="pagibig" name="pagibig" value="{{ old('pagibig', $employee->pagibig) }}" placeholder="XXXX-XXXXXX-XX">
                                        @error('pagibig')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('birthdate') is-invalid @enderror" 
                                               id="birthdate" name="birthdate" value="{{ old('birthdate', $employee->birthdate ? $employee->birthdate->format('Y-m-d') : '') }}">
                                        @error('birthdate')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('notes') is-invalid @enderror" 
                                                  id="notes" name="notes" rows="4" placeholder="Additional notes about the employee...">{{ old('notes', $employee->notes) }}</textarea>
                                        @error('notes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-info mt-3">
                                <small>
                                    ...
                                    <strong>Tip:</strong> Changes will be saved immediately when you click "Update Employee".
                                </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <small class="text-muted">Contract Type:</small><br>
                                ...
                                <div class="col-6">
                                    ...
                                    <span class="text-muted">{{ $employee->role ?: 'N/A' }}</span>
                                </div>
                            </div>
                            @if($employee->contract_start)
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <small class="text-muted">Contract Start:</small><br>
                                        <span class="text-muted">{{ $employee->formatted_contract_start }}</span>
